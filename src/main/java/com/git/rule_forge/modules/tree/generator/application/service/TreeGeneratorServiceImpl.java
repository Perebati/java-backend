package com.git.rule_forge.modules.tree.generator.application.service;
...
import com.git.rule_forge.modules.tree._shared.domain.RootTreeHistory;
...
class TreeGeneratorServiceImpl implements TreeGeneratorService {
    ...
    protected void processNode(Node<?> parentEntity, Node<?> tree) throws SystemGlobalException {
        switch (tree.getNodeType()) {
            ...
            default -> throw new IllegalArgumentException("Unexpected value: " + tree.getNodeType());
        }
    }
